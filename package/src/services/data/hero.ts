import { HeroData } from "@/types/resume";
...
export const heroDataId: HeroData = {
  name: "Rohmat Choiruly Anwar",
  title: "Pengembang",
  description: `Lulusan baru Diploma (D3) Teknologi Informasi dengan minat mendalam pada inovasi teknologi. Memiliki
pengalaman praktis dalam pengembangan aplikasi web modern dan implementasi sistem Internet of Things
(IoT). Pernah bekerja secara project-based mengembangkan aplikasi logistik menggunakan ekosistem Next.js,
React, dan TailwindCSS dalam arsitektur Turbo Monorepo. Berpengalaman dalam memanfaatkan teknologi AI
untuk efisiensi coding, serta memiliki dasar yang kuat dalam pemecahan masalah teknis. Siap berkontribusi
