...
export const experienceDataEn: ExperienceItem[] = [
  {
    ...
    description:
      "Collaborated with the developer team to build 25 company profile websites for various export companies in Indonesia, creating institutional websites for clients across different industries. Conducted testing and debugging to ensure compatibility and optimal website performance across browsers.",
  },
  {
    id: 2,
    role: "Frontend Developer (Next.js 15 & Monorepo)",
    company: "PT AZLOGISTIK DOT COM — Surabaya (Project Based)",
...
export const experienceDataId: ExperienceItem[] = [
  {
    ...
    role: "Web Developer Intern",
    company: "PT Elecomp Indonesia, Malang",
    period: "Januari - Juli 2024",
    description:
      "Berkolaborasi dengan tim developer untuk membangun 25 website company profile dari beberapa perusahaan ekspor di Indonesia, membuat website instansi bagi klien dari berbagai industri. Melakukan testing dan debugging untuk memastikan kompatibilitas dan performa website yang optimal di browser.",
  },
  {
    id: 2,
    role: "Frontend Developer (Next.js 15 & Monorepo)",
